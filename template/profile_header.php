<header class="d-flex flex-row m-3 mt-0 mb-0 pt-4 pb-3 border-bottom border-primary border-3 border-primary bg-secondary justify-content-around">
    <div class="d-flex flex-column">
        <img src="<?= str_replace("../", "", $profile["profilePicture"]); ?>" alt="Profile picture" class=" profile-image rounded-pill border border-4 border-primary ratio ratio-1x1 mb-1 mt-1">
    ...
    <div class="d-flex flex-column align-items-center">
        ...
        <?php else : ?>
            <?php if ($template_params["isFriend"]) : ?>
                <button id="removeFriend" class="friend-button btn btn-primary btn-sm bg-secondary text-dark border-2 border-primary">remove from
                    friends</button>
            ...
            <?php else : ?>
                ...
                <button id="removeFriend" class="friend-button btn btn-primary btn-sm bg-secondary text-dark border-2 border-primary" hidden>remove
                    from friends</button>
            <?php endif; ?>
        <?php endif; ?>
